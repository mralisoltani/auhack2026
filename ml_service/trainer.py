"""Training logic for spot price prediction. Extracted from dashboard for API use."""
import numpy as np
import pandas as pd
...
def temporal_split(X: pd.DataFrame, y: pd.Series, val_frac: float = 0.1, test_frac: float = 0.1):
